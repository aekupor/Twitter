...
public class TwitterClient extends OAuthBaseClient {
	...
	public void replyTweet(String tweetContent, Long inResponseToId, JsonHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/update.json");
		RequestParams params = new RequestParams();
		params.put("status", tweetContent);
	...
	public void getFollowingList(long userId, JsonHttpResponseHandler handler) {
	...
	public void getUserTweets(long userId, JsonHttpResponseHandler handler) {
	...
	public void getUserTweets(JsonHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/user_timeline.json");
		RequestParams params = new RequestParams();
		params.put("count", 200);
		client.get(apiUrl, params, handler);
	...
	public void getUserLikes(JsonHttpResponseHandler handler) {
